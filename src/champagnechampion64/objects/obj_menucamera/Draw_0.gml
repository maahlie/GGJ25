...
var zto = self.z - dsin(self.pitch) + 48;
var xfrom = self.x;
var yfrom = self.y;
var zfrom = self.z + 48;
...
matrix_set(matrix_world, matrix_build(100, 136, self.z-18, 0, 0, hobodir, 0.1, 0.1, 0.1));
vertex_submit( obj_menucamera.vb_guy, pr_trianglelist, -1);
